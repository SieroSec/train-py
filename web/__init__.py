...
####################
# postgres show tables: \dt OR \dt+ (describe tables)
#
#
#
####################
...
def create_app(test_config=None):
    ...
    def log_out():
        if request.method == 'GET':
            session.clear()
            flash('Successfully logged out. GET method', 'success')
            return redirect(url_for('log_in'))
        elif request.method == 'DELETE':
            session.clear()
            flash('Successfully logged out. DELETE method', 'success')
            return redirect(url_for('log_in'))
        else :
            session.clear()
            flash('Successfully logged out. UNKNOWN method', 'success')
            return redirect(url_for('log_in'))
